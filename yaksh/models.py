...
enrollment_methods = (
    ("default", _("Enroll Request")),
    ("open", _("Open Enrollment")),
    )
...
class Course(models.Model):
    ...
    enrollment = models.CharField(_('enrollment'), max_length=32, choices=enrollment_methods)
    ...
    is_trial = models.BooleanField(default=False)
    instructions = models.TextField(_('instructions'), default=None, null=True, blank=True)
    view_grade = models.BooleanField(_('view grade'), default=False)
    ...
    start_enroll_time = models.DateTimeField(
        _("Start Date and Time for enrollment of course"),
        default=timezone.now,
        null=True
    )
    ...
    end_enroll_time = models.DateTimeField(
        _("End Date and Time for enrollment of course"),
        default=datetime(
            2199, 1, 1,
            tzinfo=pytz.timezone(timezone.get_current_timezone_name())
        ),
